...
public class VisBiscuitProductAdapter extends RecyclerView.Adapter<VisBiscuitProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;

    public VisBiscuitProductAdapter(Context context, List<String> productNames){
