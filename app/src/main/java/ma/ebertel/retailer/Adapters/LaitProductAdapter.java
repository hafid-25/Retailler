...
public class LaitProductAdapter extends RecyclerView.Adapter<LaitProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;
    CompoundButton.OnCheckedChangeListener checkListner;

    public LaitProductAdapter(Context context, List<String> productNames, CompoundButton.OnCheckedChangeListener listener){
