...
public class DetergentProductAdapter extends RecyclerView.Adapter<DetergentProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;
    CompoundButton.OnCheckedChangeListener checkListner;

    public DetergentProductAdapter(Context context,List<String> productNames,CompoundButton.OnCheckedChangeListener listener){
    ...
    public void onBindViewHolder(@NonNull ProductHolder holder, int position) {
        ...
        holder.checkBox.setTag("detergent");
