...
public class VisLaitProductAdapter extends RecyclerView.Adapter<VisLaitProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;

    public VisLaitProductAdapter(Context context, List<String> productNames){
