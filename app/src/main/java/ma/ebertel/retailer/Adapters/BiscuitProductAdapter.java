...
public class BiscuitProductAdapter extends RecyclerView.Adapter<BiscuitProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;
    CompoundButton.OnCheckedChangeListener checkListner;

    public BiscuitProductAdapter(Context context, List<String> productNames, CompoundButton.OnCheckedChangeListener listener){
    ...
    public void onBindViewHolder(@NonNull ProductHolder holder, int position) {
        ...
        holder.checkBox.setTag("biscuit");
