...
public class PateProductAdapter extends RecyclerView.Adapter<PateProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;
    CompoundButton.OnCheckedChangeListener checkListner;

    public PateProductAdapter(Context context, List<String> productNames, CompoundButton.OnCheckedChangeListener listener){
