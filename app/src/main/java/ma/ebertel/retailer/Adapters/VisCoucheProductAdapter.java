...
public class VisCoucheProductAdapter extends RecyclerView.Adapter<VisCoucheProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;

    public VisCoucheProductAdapter(Context context, List<String> productNames){
