...
public class VisThéProductAdapter extends RecyclerView.Adapter<VisThéProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;

    public VisThéProductAdapter(Context context, List<String> productNames){
