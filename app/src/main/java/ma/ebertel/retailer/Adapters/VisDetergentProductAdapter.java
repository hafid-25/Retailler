...
public class VisDetergentProductAdapter extends RecyclerView.Adapter<VisDetergentProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;

    public VisDetergentProductAdapter(Context context, List<String> productNames){
