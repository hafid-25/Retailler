...
public class CoucheProductAdapter extends RecyclerView.Adapter<CoucheProductAdapter.ProductHolder> {

    List<String> productNames;
    Context context;
    CompoundButton.OnCheckedChangeListener checkListner;

    public CoucheProductAdapter(Context context, List<String> productNames, CompoundButton.OnCheckedChangeListener listener){
